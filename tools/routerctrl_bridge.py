...
#
#      python -c "import compileall,sys; sys.exit(0 if compileall.compile_file('tools/routerctrl_bridge.py') else 1)"
#
...
#
#      python tools/routerctrl_bridge.py pppoe --ip 192.168.0.1 --user admin --pass x --param nosuchkey=1
#
...
def usage():
    ...
    lines = []
    lines.append('usage: python tools/routerctrl_bridge.py <mode> --ip IP '
