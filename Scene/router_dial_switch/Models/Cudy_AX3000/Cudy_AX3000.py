...
用法(默认只切换不保存;确认回读无误后加 --apply 才真正下发):
    python Models/Cudy_AX3000/Cudy_AX3000.py dynamic
    python Models/Cudy_AX3000/Cudy_AX3000.py pppoe --apply
...
与 Models/Cudy_AX1500/Cudy_AX1500.py(老式 frameset 固件)不是同一台/同一固件 —— 那台是
