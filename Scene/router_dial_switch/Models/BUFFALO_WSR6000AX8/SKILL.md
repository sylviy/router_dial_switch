...
这台机是:**radio 组,设置页要以 iframe 打开,账密在另一页**。
...
下面每个值都是**从 `BUFFALO_WSR6000AX8.py` 的 FACTS 抄下来的**。真相以 FACTS 为准 ——
...
控件:
  拨号控件:
    形态: radio 组        # act.py 的 --kind radio
...
```
python ../../Tools/probe_dump.py  --menu "sel:p.CONNECT[data-main='wan.html']"
python ../../Tools/list_modes.py  --menu "sel:p.CONNECT[data-main='wan.html']" --dial "input[name='WanMethod']"
python ../../Tools/probe_count.py --menu "sel:p.CONNECT[data-main='wan.html']" \
    --sel "input[name='WanMethod']" --sel "div#button_1"
python ../../Tools/act.py         --menu "sel:p.CONNECT[data-main='wan.html']" --kind radio \
    --sel "input#id_method2" --label "dynamic"
python ../../Tools/act.py         --menu "sel:p.CONNECT[data-main='wan.html']" --kind radio \
    --sel "input#id_method2" --label "dynamic" \
    --apply-sel "div#button_1" --reload-verify
```
...
Models/BUFFALO_WSR6000AX8/
    BUFFALO_WSR6000AX8.py     交付物本体,**一个文件自足**
    SKILL.md              就是本文件
